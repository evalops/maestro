...
| published replay | text, JSON, and RPC replay modes keep session, tool, approval, search/ripgrep, error, artifact, final-status, query-index, and AgentRuntime evidence. |
