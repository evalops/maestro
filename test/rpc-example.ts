...
/**
 * Interactive example of using Playwright in RPC mode
...
// Parse agent events
readline
	.createInterface({ input: agent.stdout, terminal: false })
	.on("line", (line: string) => {
		try {
...
console.log("Interactive Playwright RPC mode example. Type 'exit' to quit.\n");
process.stdout.write("You: ");
