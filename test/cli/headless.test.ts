...
describe("headless protocol helpers", () => {
	...
	it("ignores viewer hello negotiation for disallowed mcp_elicitation requests", () => {
		const state = createHeadlessRuntimeState();
	...
	it("ignores viewer hello renegotiation that adds disallowed mcp_elicitation requests", () => {
		const state = createHeadlessRuntimeState();
