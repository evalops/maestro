...
# 3. Check browser-captured console output and page errors
...
4. **Console errors** — `agent-browser console` and `agent-browser errors` show no failures
...
# Check browser-captured console output and page errors
agent-browser console
agent-browser errors
