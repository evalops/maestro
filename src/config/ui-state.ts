...
/**
 * Footer display density. Defined here (rather than in the TUI's own
 * footer-rendering code) because it's part of the persisted UI preference
 * shape shared by the TUI, the web UI store, and the server handlers.
 */
