...
const PLATFORM_MCP_WORKSPACE_ENV_VARS: readonly string[] = [
...
const PLATFORM_MCP_INTEGRATION_PROFILE_ENV_VARS =
	EVALOPS_INTEGRATION_PROFILE_ENV_VARS;
const PLATFORM_MCP_MEMORY_MODE_ENV_VARS = EVALOPS_MEMORY_MODE_ENV_VARS;
const PLATFORM_MCP_RUNTIME_OWNER_ENV_VARS = EVALOPS_RUNTIME_OWNER_ENV_VARS;
const PLATFORM_MCP_SHIM_TYPE_ENV_VARS = EVALOPS_SHIM_TYPE_ENV_VARS;
const PLATFORM_MCP_TRACE_MODE_ENV_VARS = EVALOPS_TRACE_MODE_ENV_VARS;
