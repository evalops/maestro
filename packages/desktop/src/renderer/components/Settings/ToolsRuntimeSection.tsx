	...
	return (
		<section className="border border-line-subtle rounded-xl overflow-hidden">
			...
			<div className="p-4 space-y-5">
				...
				<ToolsRuntimePackages
					packages={packages}
					onRefreshPackageStatus={onRefreshPackageStatus}
					onInspectPackage={onInspectPackage}
					onPrunePackageCache={onPrunePackageCache}
					onRefreshAllPackages={onRefreshAllPackages}
					onRefreshPackage={onRefreshPackage}
