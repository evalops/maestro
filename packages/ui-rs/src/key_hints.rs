...
fn key_to_string(key: KeyCode) -> String {
    match key {
        KeyCode::Enter => crate::localization::tr("Enter").to_string(),
        KeyCode::Esc => crate::localization::tr("Esc").to_string(),
        KeyCode::Backspace => crate::localization::tr("Backspace").to_string(),
        KeyCode::Tab => crate::localization::tr("Tab").to_string(),
        KeyCode::Delete => crate::localization::tr("Del").to_string(),
        KeyCode::Insert => crate::localization::tr("Ins").to_string(),
        KeyCode::Home => crate::localization::tr("Home").to_string(),
        KeyCode::End => crate::localization::tr("End").to_string(),
        ...
        KeyCode::Char(' ') => crate::localization::tr("Space").to_string(),
