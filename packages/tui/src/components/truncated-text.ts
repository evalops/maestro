 ...
 * Useful for single-line displays like file paths or status messages.
 * ANSI-aware: preserves escape codes while calculating visible width.
 */
export class TruncatedText implements Component {
	...
	render(width: number): string[] {
		...
		if (textVisibleWidth > availableWidth) {
			...
			let truncateAt = 0;
			let i = 0;
			const ellipsisWidth = 1; // "…" is 1 character
