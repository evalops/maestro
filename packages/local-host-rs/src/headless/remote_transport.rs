...
impl RemoteAgentTransport {
    ...
    pub fn try_recv_incoming(&mut self) -> Option<Result<RemoteIncoming, AsyncTransportError>> {
    ...
    pub async fn recv_incoming(&mut self) -> Result<RemoteIncoming, AsyncTransportError> {
        let result = self
            .event_rx
            .recv()
            .await
