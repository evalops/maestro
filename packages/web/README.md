...
This directory contains the versioned browser bundle served by the native Rust runtime gateway. The bundle is intentionally committed so building, packaging, and running Maestro never requires a TypeScript or JavaScript toolchain.
