...
- **Smart File Handling**: Automatically reads and includes content of uploaded code files
- **Scheduled Tasks**: Schedule one-time or recurring tasks ("remind me in 2 hours", "every day at 9am")
- **Approval Workflows**: Requests confirmation for potentially destructive operations
