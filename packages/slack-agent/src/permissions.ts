...
const ROLE_PERMISSIONS: Record<SlackRole, string[]> = {
	...
	user: [
		...
		"execute_tool:attach",
		"execute_tool:status",
		"execute_tool:schedule",
		"execute_tool:connector_*",
		"execute_tool:create_live_dashboard",
		"execute_tool:send_progress",
		"execute_tool:send_request",
		"execute_tool:send_final",
		"execute_tool:send_error",
		"execute_tool:send_blocker",
		"schedule_task",
		"cancel_own_task",
		"toggle_thinking",
		"view_own_costs",
