...
//!
//! ```rust,ignore
//! use maestro_runtime_contracts::BashDetails;
//!
...
pub struct BashDetails {
    ...
    /// readable denial log; see `maestro_sandbox::capture_denies`.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub sandbox_denials: Vec<maestro_sandbox::DenyEvent>,
}
...
impl BashDetails {
    ...
    #[must_use]
    pub fn with_sandbox_denials(mut self, denials: Vec<maestro_sandbox::DenyEvent>) -> Self {
...
pub struct WriteDetails {
    ...
    /// Validator summaries
    #[serde(skip_serializing_if = "Option::is_none")]
    pub validators: Option<Vec<crate::contracts::ValidatorResult>>,
}
...
impl WriteDetails {
    ...
    #[must_use]
    pub fn with_validators(mut self, validators: Vec<crate::contracts::ValidatorResult>) -> Self {
